...
/**
 * <p>Static block initialization implementation is similar to eager
 * initialization, except that instance of class is created in the
 * static block that provides option for exception handling.
 * <p>Both eager initialization and static block initialization creates
 * the instance even before it’s being used and that is not the best
 * practice to use.
 */
public class StaticBlockSingleton {
    ...
    static {
        try {
            ...
            throw new RuntimeException("Exception occured when creating Singleton.");
        }
    }
